...
public class Connection extends SQLiteOpenHelper {
    ...
    // Este é um indicador se precisarmos copiar o
    ...
    /**
     * Número de usuários da conexão do banco de dados.
     * */
    private int mOpenConnections = 0;

    private static Connection mInstance;

    synchronized static public Connection getInstance(Context context) {
        if (mInstance == null) {
